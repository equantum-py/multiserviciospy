...
export function AdminSystemStatus() { return <div className="grid gap-3 sm:grid-cols-3"><StatusItem label="Base de datos" value="Conectada" /><StatusItem label="Storage" value="Configurado" /><StatusItem label="Autenticación Admin" value="Pendiente" pending /></div>; }
